			 ...
			 const string &default_prefix)
{
	...
	WCHAR * str1;
	int n = MultiByteToWideChar(CP_ACP, 0, query_string.c_str(), -1, NULL, 0);
	str1 = new WCHAR[n];
	MultiByteToWideChar(CP_ACP, 0, query_string.c_str(), -1, str1, n); n = WideCharToMultiByte(CP_UTF8, 0, str1, -1, NULL, 0, NULL, NULL);
	...
	delete[]str2;
	str2 = NULL;
    Query result = internal->parse_query(strOutUTF8, flags, default_prefix);
				...
				bool exclusive)
{
    ...
    filter_type type = (exclusive ? BOOLEAN_EXCLUSIVE : _BOOLEAN);
