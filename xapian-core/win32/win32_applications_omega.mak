...
OMINDEX_OBJS= \
	...
	"$(OUTDIR)\str.obj" \
	"$(OUTDIR)\svgparse.obj" \
	"$(OUTDIR)\atomparse.obj" \
	"$(OUTDIR)\xlsxparse.obj" \
	"$(OUTDIR)\opendocparse.obj" \
...
SRCS= \
	...
	"$(INTDIR)\diritor.cc" \
	"$(INTDIR)\runfilter.cc" \
	"$(INTDIR)\xpsxmlparse.cc" \
	"$(INTDIR)\common\stringutils.cc" \
	"$(INTDIR)\common\str.cc" \
	"$(INTDIR)\common\safe.cc" \
	"$(INTDIR)\transform.cc" \
	"$(INTDIR)\xlsxparse.cc" \
	"$(INTDIR)\svgparse.cc" \
	...
	"$(INTDIR)\atomparse.cc" \
	"$(INTDIR)\expand.cc" \
	"$(INTDIR)\opendocparse.cc" \
	"$(INTDIR)\pkglibbindir.cc"
