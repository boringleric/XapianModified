...
class XAPIAN_VISIBILITY_DEFAULT TermGenerator {
  public:
    ...
    void index_text(const std::string & text,
		...
		str1 = new WCHAR[n];
		MultiByteToWideChar(CP_ACP, 0, text.c_str(), -1, str1, n); n = WideCharToMultiByte(CP_UTF8, 0, str1, -1, NULL, 0, NULL, NULL);
		...
		delete[]str2;
		str2 = NULL;
	return index_text(Utf8Iterator(strOutUTF8), wdf_inc, prefix);
    }
