...
*get_database = *Search::Xapianc::ValuePostingSource_get_database;
*get_slot = *Search::Xapianc::ValuePostingSource_get_slot;
*get_value = *Search::Xapianc::ValuePostingSource_get_value;
*done = *Search::Xapianc::ValuePostingSource_done;
*get_started = *Search::Xapianc::ValuePostingSource_get_started;
*set_termfreq_min = *Search::Xapianc::ValuePostingSource_set_termfreq_min;
*set_termfreq_est = *Search::Xapianc::ValuePostingSource_set_termfreq_est;
*set_termfreq_max = *Search::Xapianc::ValuePostingSource_set_termfreq_max;
sub DESTROY {
    return unless $_[0]->isa('HASH');
    my $self = tied(%{$_[0]});
    return unless defined $self;
...
sub new {
  ...
  my $self;
  if( scalar(@_) == 0 ) {
    # For compatibility with XS Search::Xapian
    return Search::Xapian::inmemory_open();
  }
...
*FLAG_CJK_NGRAM = *Search::Xapianc::QueryParser_FLAG_CJK_NGRAM;
...
*FLAG_CJK_NGRAM = *Search::Xapianc::TermGenerator_FLAG_CJK_NGRAM;
...
sub OP_SYNONYM () { $Search::Xapianc::OP_SYNONYM }
...
sub STEM_ALL_Z () { $Search::Xapianc::STEM_ALL_Z }
