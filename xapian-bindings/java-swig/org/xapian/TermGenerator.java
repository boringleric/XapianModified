...
public class TermGenerator {
  ...
  public final static class flags {
    ...
    public final static TermGenerator.flags FLAG_CJK_NGRAM = new TermGenerator.flags("FLAG_CJK_NGRAM", XapianJNI.TermGenerator_FLAG_CJK_NGRAM_get());
    ...
    private static flags[] swigValues = { FLAG_SPELLING, FLAG_CJK_NGRAM };
